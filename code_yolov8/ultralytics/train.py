...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='ultralytics/cfg/datasets/VOC_self.yaml', help='data yaml path')
    ...
    parser.add_argument('--batch', type=int, default=64, help='number of images per batch (-1 for AutoBatch)')
